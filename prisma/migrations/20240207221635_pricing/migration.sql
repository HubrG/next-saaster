/*
  ...
  - A unique constraint covering the columns `[MRRSPlanId,couponId,recurrence]` on the table `StripePlanCoupon` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "StripePlanCoupon_MRRSPlanId_couponId_recurrence_key" ON "StripePlanCoupon"("MRRSPlanId", "couponId", "recurrence");
