    ...
    <Suspense fallback={<SkeletonLoader />}>
      <div className="blog-sidebar">
        <div className=" max-h-[28vh]">
          ...
          <ScrollArea className="h-full w-full p-3 border-app-200 bg-theming-background-100/20 rounded-default border border-dashed shadow-sm">
            <ul>
              {categories.length > 0 ? (
        ...
        <div className="max-h-[51vh]">
          ...
          <ScrollArea className="h-full p-3 w-full border-app-200  bg-theming-background-100/20 rounded-default border border-dashed shadow-sm">
